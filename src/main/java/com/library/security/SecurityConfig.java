    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/api/books/trending").permitAll()
                        .requestMatchers("/api/books/genres").permitAll()
                        .requestMatchers("/api/books/available").permitAll()
                        .requestMatchers("/api/books/digital").permitAll()
                        .requestMatchers("/", "/index.html", "/static/**", "/*.html", "/*.css", "/*.js").permitAll()
                        .requestMatchers("/api/admin/**").hasRole("ADMIN")
                        .requestMatchers("/api/borrowings/**").hasRole("USER")
                        .requestMatchers("/api/digital-books/**").authenticated()
